...
public class CashDrawerRepository : GenericRepository<CashDrawer>, ICashDrawerRepository
{
    public CashDrawerRepository(TuColmadoDbContext dbContext) : base(dbContext)
    {
    }
}
